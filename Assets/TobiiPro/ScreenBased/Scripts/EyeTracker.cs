...
namespace Tobii.Research.Unity
{
    public class EyeTracker : EyeTrackerBase
    {
        ...
        private bool _connectToFirst = true;
        ...
        {
            const int maxIterations = 120; // Tobii Pro Spark @ 60Hz: permite hasta 2s de buffer
        ...
        protected override void StartAutoConnectThread()
        {
            ...
            _autoConnectThread = new Thread(() =>
            {
                ...
                while (AutoConnectThreadRunning)
                {
                    ...
                    {
                        if (true || _connectToFirst || eyeTrackerEntry.SerialNumber.StartsWith(_eyeTrackerSerialStart))
                        {
