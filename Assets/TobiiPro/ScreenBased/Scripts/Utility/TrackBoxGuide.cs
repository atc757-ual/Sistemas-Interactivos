    ...
    public class TrackBoxGuide : MonoBehaviour
    {
        ...
        public bool TrackBoxGuideActive
        {
            ...
            set
            {
                ...
                if (_eyeTracker != null) _eyeTracker.SubscribeToUserPositionGuide = value;
                if (_CanvasTrackBox != null) _CanvasTrackBox.SetActive(_trackBoxGuideActive);
            }
        }
        ...
        private void Update()
        {
            if (_CanvasTrackBox == null) return; // Parche Senior para evitar errores de referencia
